data "openstack_networking_network_v2" "kypo-network" {
    name = "kypo-network"
}

data "openstack_networking_secgroup_v2" "kypo-sandbox-access-sg" {
    name = "kypo-sandbox-access-sg"
}

data "openstack_networking_secgroup_v2" "kypo-sandbox-man-sg" {
    name = "kypo-sandbox-man-sg"
}

data "openstack_networking_secgroup_v2" "kypo-sandbox-internal-sg" {
    name = "kypo-sandbox-internal-sg"
}

data "openstack_networking_secgroup_v2" "kypo-sandbox-man-int-sg" {
...
resource "openstack_networking_port_v2" "stack-name-link-5" {
    ...
    admin_state_up = "true"
    security_group_ids = [
        data.openstack_networking_secgroup_v2.kypo-sandbox-internal-sg.id
    ]
...
resource "openstack_networking_port_v2" "stack-name-link-1" {
    ...
    admin_state_up = "true"
    security_group_ids = [
        data.openstack_networking_secgroup_v2.kypo-sandbox-man-sg.id
    ]
...
resource "openstack_networking_port_v2" "stack-name-link-3" {
    ...
    admin_state_up = "true"
    security_group_ids = [
        data.openstack_networking_secgroup_v2.kypo-sandbox-man-int-sg.id
    ]
...
resource "openstack_compute_instance_v2" "stack-name-server" {
    ...
    flavor_name = "csirtmu.tiny1x2"
    key_pair = "kypo-dummy-ssh-key-pair"
    config_drive = "true"
...
resource "openstack_networking_port_v2" "stack-name-man-out-port" {
    ...
    network_id = data.openstack_networking_network_v2.kypo-network.id
    admin_state_up = "true"
    security_group_ids = [
        data.openstack_networking_secgroup_v2.kypo-sandbox-access-sg.id
    ]
