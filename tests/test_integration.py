...
class TestIntegration:
    key_pair_name = "kypo-lib-key-testing-1"
    sandbox_name = "kypo-lib-sb-testing-1"
    ...
    def os_client(self):
        ...
        trc = TransformationConfiguration("debian-9-x86_64", "csirtmu.tiny1x2", "root", base_network=self.base_network_name)
        return KypoOpenStackClient(auth_url, application_credential_id, application_credential_secret, trc)
